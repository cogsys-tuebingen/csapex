...
public:
    ...
    void publish(typename T::Ptr message,
                 std::string frame_id = "/",
                 typename boost::enable_if<connection_types::should_use_pointer_message<T> >::type* dummy = 0) {
    ...
    void publish(T message,
                 std::string frame_id = "/",
                 typename boost::enable_if<connection_types::should_use_value_message<T> >::type* dummy = 0) {

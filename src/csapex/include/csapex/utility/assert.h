...
void CSAPEX_UTILS_EXPORT _apex_assert(bool assertion, const char* msg, const char* code, const char* file, int line);
void CSAPEX_UTILS_EXPORT _apex_assert_hard(bool assertion, const char* msg, const char* code, const char* file, int line);
void CSAPEX_UTILS_EXPORT _apex_assert_soft(bool assertion, const char* msg, const char* code, const char* file, int line);

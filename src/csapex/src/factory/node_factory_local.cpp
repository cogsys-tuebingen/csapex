...
NodeFactoryLocal::NodeFactoryLocal(Settings& settings, PluginLocator* locator)
...
void NodeFactoryLocal::loadPlugins()
{
    ensureLoaded();
...
void NodeFactoryLocal::shutdown()
{
    tag_map_.clear();
    constructors_.clear();
}

void NodeFactoryLocal::rebuildPrototypes()
{
...
void NodeFactoryLocal::rebuildMap()
{
...
void NodeFactoryLocal::registerNodeType(NodeConstructor::Ptr provider, bool suppress_signals)
{
...
NodeFacadeLocalPtr NodeFactoryLocal::makeGraph(const UUID& uuid, const UUIDProviderPtr& uuid_provider)
{

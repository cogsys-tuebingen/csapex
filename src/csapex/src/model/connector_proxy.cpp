...
ConnectorProxy::ConnectorProxy(const SessionPtr& session, UUID uuid, ConnectableOwnerPtr owner, const ConnectorDescription& cd)
    : ConnectorProxy(session, uuid, owner)
{

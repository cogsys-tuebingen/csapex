...
GraphFacadeImplementation::GraphFacadeImplementation(ThreadPool &executor, GraphImplementationPtr graph, SubgraphNodePtr graph_node,
                                   NodeFacadeImplementationPtr nh, GraphFacadeImplementation *parent)
...
ConnectionPtr GraphFacadeImplementation::connect(NodeHandlePtr output, int output_id,
                                        NodeHandlePtr input, int input_id)
{
    return connect(output.get(), output_id, input.get(), input_id);
}

ConnectionPtr GraphFacadeImplementation::connect(const UUID& output_id,
                                        NodeHandlePtr input, int input_id)
{
...
ConnectionPtr GraphFacadeImplementation::connect(NodeHandlePtr output, const std::string& output_id,
                                        const UUID& input_id)
{
    return connect(output.get(), output_id, input_id);
}

ConnectionPtr GraphFacadeImplementation::connect(NodeHandle* output, const std::string& output_id,
                                        const UUID& input_id)
{
...
ConnectionPtr GraphFacadeImplementation::connect(NodeHandle *output, int output_id,
...
ConnectionPtr GraphFacadeImplementation::connect(NodeHandle *output, const std::string& output_name,

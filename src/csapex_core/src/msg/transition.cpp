...
Transition::Transition(delegate::Delegate0<> activation_fn) : activation_fn_(activation_fn)
{
}
...
void Transition::trackConnection(Connection* connection, const slim_signal::Connection& c)
{

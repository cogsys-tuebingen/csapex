...
/// REQUEST
///
CoreRequests::CoreRequest::CoreRequest(CoreRequestType request_type) : RequestImplementation(0), request_type_(request_type)
{
}

CoreRequests::CoreRequest::CoreRequest(uint8_t request_id) : RequestImplementation(request_id)
{
}

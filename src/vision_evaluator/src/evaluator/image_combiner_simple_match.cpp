...
REGISTER_IMAGE_COMBINER(ImageCombinerSimpleMatch)
...
ImageCombiner::TypePtr ImageCombinerSimpleMatch::createInstance(CONSTRUCTOR_MODE mode)
{
    return ImageCombiner::TypePtr(new ImageCombinerSimpleMatch("Simple Match"));
}
